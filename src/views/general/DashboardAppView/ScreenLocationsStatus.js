...
ScreenLocationsStatus.propTypes = {
  className: PropTypes.string
};

function ScreenLocationsStatus({ className, ...other }) {
  const classes = useStyles();

  return (
    <Card className={clsx(classes.root, className)} {...other}>
      <CardHeader title="Screen Locations Status" />
      <CardContent>
        <Scrollbars>
...
export default ScreenLocationsStatus;
