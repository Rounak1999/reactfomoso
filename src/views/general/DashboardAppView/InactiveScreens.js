...
function InactiveScreens({ className, ...other }) {
  ...
  return (
    <Card className={clsx(classes.root, className)} {...other}>
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle2">Inactive Screens</Typography>
     ...
     {/*    <br />Click will land on screens tab */}
      </Box>
      <ReactApexChart
        type="bar"
        width={60}
...
export default InactiveScreens;
